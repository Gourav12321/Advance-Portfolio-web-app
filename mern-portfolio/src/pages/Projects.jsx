    ...
    <div className="text-white w-[96%]">
      ...
      <div className="text-white z-10 relative md:pl-0 pl-5">
        ...
        <div className='flex justify-center space-x-4'>
          ...
          <button onClick={() => handleCategoryChange('Full Stack Web App')} className="category-button">Full Stack Web Apps</button>
          <button onClick={() => handleCategoryChange('React App')} className="category-button">React Apps</button>
        </div>
        <div className='flex flex-wrap justify-evenly mt-8 w-full'>
          {filteredProjects.map((project, index) => (
            ...
            >
              <img src={project.imageUrl} alt={project.title} className='project-image w-[100%] h-[14rem]' />
              <div className='project-info'>
                ...
                <div className='project-achievements'>
                  {project.achievements && project.achievements.map((achievement, index) => (
                    <a key={index} href={achievement.link} target='_blank' rel='noopener noreferrer'>
                      <img src={achievement.imageUrl} alt={`Achievement ${index + 1}`} className='achievement-image' />
                    </a>
                  ))}
                </div>
              </div>
