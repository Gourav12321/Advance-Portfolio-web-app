...
function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('/api/admin/contactinfo', data);
  ...
  return (
    <div className="text-white w-full relative">
      ...
      <div ref={contactRef} className={`text-white text-[1.2rem] font-semibold mt-[1rem] mx-8 z-10 relative ${contactInView ? 'animate-fade-in' : 'opacity-0'}`}>
        ...
        <div className="lg:flex w-full my-[1.7rem] text-[1rem] gap-[6vw]">
          <div className="bg-[#2C2C39] p-8 w-full lg:w-[17.5rem] text-[14px] mb-[46px] font-bold leading-4">
            ...
            <p className="flex justify-between">
              <span>Address:</span>
              <span className="w-[110px] text-end">E-51, Jain Colony Barwala</span>
            </p>
            <br />
          </div>
      ...
      <div ref={formRef} className={`z-10 relative mx-8 font-semibold pb-[8rem] md:pr-10 md:w-full lg:w-full lg:pr-[10vw] ${formInView ? 'animate-fade-in' : 'opacity-0'}`}>
        <h2>Get In Touch</h2>
